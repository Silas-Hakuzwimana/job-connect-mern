        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors hover:underline">Browse Jobs</a></li>
              <li><a href="#" className="hover:text-white transition-colors hover:underline">Career Resources</a></li>
              <li><a href="#" className="hover:text-white transition-colors hover:underline">Resume Builder</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors hover:underline">Post Jobs</a></li>
              <li><a href="#" className="hover:text-white transition-colors hover:underline">Talent Search</a></li>
              <li><a href="#" className="hover:text-white transition-colors hover:underline">Pricing Plans</a></li>
              <li><a href="#" className="hover:text-white transition-colors hover:underline">Recruiting Tools</a></li>
            </ul>
          </div>
